...
//TODO dodělat všechny figurky - vez, kun, strelec, kralovna
...
//        vypisPole();
        ...
        while (true) {
            ...
            posunFigurku(odRadek, odSloupec, doRadek, doSloupec);
            vypisPole();
        }
     ...
     */
    private void posunFigurku(int odRadek, int odSloupec, int doRadek, int doSloupec) {
